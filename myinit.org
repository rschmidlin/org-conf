  ...
  (eval-after-load "ergoemacs"
    (progn
      (ergoemacs-component history-workaround ()
        ...
        (define-key minibuffer-local-map (kbd "M-p") 'minibuffer-insert-word-at-point)
        ...
        (define-key vr/minibuffer-keymap (kbd "M-p") 'minibuffer-insert-word-at-point)
        ...
        (define-key ivy-minibuffer-map (kbd "M-p") 'minibuffer-insert-word-at-point))
