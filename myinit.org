...
#+BEGIN_SRC emacs-lisp
  ...
  (define-key ergoemacs-light-mode-map (kbd "M-h") 'smarter-move-beginning-of-line)
  ...
  (define-key ergoemacs-light-mode-map (kbd "M-G") (lambda ()
						     (interactive)
						     (kill-visual-line -1)))
  (define-key ergoemacs-light-mode-map (kbd "M-ä") 'comment-dwim)
  ...
  (define-key ergoemacs-light-mode-map (kbd "C-y") 'undo-tree-visualize)
