...
#+BEGIN_SRC emacs-lisp
  ...
  (add-hook 'isearch-pre-command-hook 'isearch-hook)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Buffer navigation
  (define-key ergoemacs-light-mode-map (kbd "C-M-f") 'swiper)
  ...
  (define-key ergoemacs-light-mode-map (kbd "C-S-y") 'undo-tree-visualize)
