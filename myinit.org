...
#+BEGIN_SRC emacs-lisp
  ...
  (eval-after-load "ergoemacs"
    (progn
      (ergoemacs-component company-keybindings ()
        "Company keybindings for Ergoemacs"
        (define-key company-active-map (kbd "M-i") 'company-select-next)
        (define-key company-active-map (kbd "M-p") 'company-select-previous)
        (ergoemacs-require 'company-keybindings))))
